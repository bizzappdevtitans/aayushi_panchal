...
class CourseDetails(models.Model):
    ...
    faculty_course = fields.Many2one("faculty.details", string="Course faculty")
    course_class = fields.Many2one("class.details", string="Class course")
    students = fields.One2many("student.details", "student_course", string="Students :")
